...
class JobAdMatchingData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'skills' => 'AnyOfRequiredAndPreferredConstrainedListValueRequiredConstrainedListValuePreferredConstrainedListValue',
     ...
     * Gets skills
     *
     * @return AnyOfRequiredAndPreferredConstrainedListValueRequiredConstrainedListValuePreferredConstrainedListValue
     */
     ...
     * Sets skills
     *
     * @param AnyOfRequiredAndPreferredConstrainedListValueRequiredConstrainedListValuePreferredConstrainedListValue $skills Required or preferred skills.
     *
     * @return self
     */
    ...
    public function setRelatedJobTitles($related_job_titles)
    {
        ...
        if (!is_null($related_job_titles) && (count($related_job_titles) > 6)) {
            throw new \InvalidArgumentException('invalid value for $related_job_titles when calling JobAdMatchingData., number of items must be less than or equal to 6.');
        }
