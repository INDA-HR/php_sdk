...
/**
 * JobAdMatchingData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class JobAdMatchingData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JobAdMatchingData';
    ...
    */
    ...
    public function setRelatedJobTitles($related_job_titles)
    {
        ...
        if ((count($related_job_titles) > 10)) {
            throw new \InvalidArgumentException('invalid value for $related_job_titles when calling JobAdMatchingData., number of items must be less than or equal to 10.');
        }
        if ((count($related_job_titles) < 1)) {
            throw new \InvalidArgumentException('invalid length for $related_job_titles when calling JobAdMatchingData., number of items must be greater than or equal to 1.');
        }
