...
class License implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'license_type_code' => 'setLicenseTypeCode',
    ...
    protected static $getters = [
        ...
        'license_type_code' => 'getLicenseTypeCode',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('license_type_code', $data ?? [], null);
        $this->setIfExists('first_issued_date', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets license_type_code
     *
     * @return \OpenAPI\Client\Model\DrivingLicenseTypeCode|null
     */
    public function getLicenseTypeCode()
    {
        return $this->container['license_type_code'];
    }

    /**
     * Sets license_type_code
     *
     * @param \OpenAPI\Client\Model\DrivingLicenseTypeCode|null $license_type_code license_type_code
     *
     * @return self
     */
    public function setLicenseTypeCode($license_type_code)
    {
        if (is_null($license_type_code)) {
            throw new \InvalidArgumentException('non-nullable license_type_code cannot be null');
        }
        $this->container['license_type_code'] = $license_type_code;
    ...
    {
        if (is_null($first_issued_date)) {
            throw new \InvalidArgumentException('non-nullable first_issued_date cannot be null');
        }
