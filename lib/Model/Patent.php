...
class Patent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('patent_title', $data ?? [], null);
        $this->setIfExists('patent_id', $data ?? [], null);
        $this->setIfExists('patent_status', $data ?? [], null);
        $this->setIfExists('description', $data ?? [], null);
        $this->setIfExists('inventor_names', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($patent_title)) {
            throw new \InvalidArgumentException('non-nullable patent_title cannot be null');
        }
    ...
    {
        if (is_null($patent_id)) {
            throw new \InvalidArgumentException('non-nullable patent_id cannot be null');
        }
    ...
    {
        if (is_null($patent_status)) {
            throw new \InvalidArgumentException('non-nullable patent_status cannot be null');
        }
    ...
    {
        if (is_null($inventor_names)) {
            throw new \InvalidArgumentException('non-nullable inventor_names cannot be null');
        }
