...
/**
 * DocumentTextResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DocumentTextResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentTextResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('file_ext', $data ?? [], null);
    ...
    */
     ...
     * Sets language
     *
     * @param string|null $language Language of the attachment.
     *
     * @return self
     */
     ...
     * Sets file_ext
     *
     * @param string|null $file_ext file_ext
     *
     * @return self
     */
    ...
    {
        if (is_null($file_ext)) {
            throw new \InvalidArgumentException('non-nullable file_ext cannot be null');
        }
