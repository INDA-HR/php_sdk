...
class SemanticHistoryBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['scroll_id'] = $data['scroll_id'] ?? null;
        $this->container['detail'] = $data['detail'] ?? true;
        $this->container['advanced'] = $data['advanced'] ?? null;
        $this->container['price'] = $data['price'] ?? true;
    }
    ...
    public function setApiCalls($api_calls)
    {
        ...
        if (!is_null($api_calls) && (count($api_calls) < 1)) {
    ...
    public function setGroupBy($group_by)
    {
        ...
        if (!is_null($group_by) && (count($group_by) < 1)) {
