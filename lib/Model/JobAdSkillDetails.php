...
/**
 * JobAdSkillDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class JobAdSkillDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JobAdSkillDetails';
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight > 1.0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling JobAdSkillDetails., must be smaller than or equal to 1.0.');
        }
        if (($weight < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling JobAdSkillDetails., must be bigger than or equal to 0.0.');
        }
