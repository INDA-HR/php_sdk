...
class JobadCommonOptionalData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\JobDescription|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\JobDescription|null $job_description job_description
     *
     * @return self
     */
     ...
     * Gets skills
     *
     * @return \OpenAPI\Client\Model\Skills|null
     */
     ...
     * Sets skills
     *
     * @param \OpenAPI\Client\Model\Skills|null $skills skills
     *
     * @return self
     */
    ...
    public function setRelatedJobTitles($related_job_titles)
    {
        ...
        if ((count($related_job_titles) > 10)) {
            throw new \InvalidArgumentException('invalid value for $related_job_titles when calling JobadCommonOptionalData., number of items must be less than or equal to 10.');
        }
