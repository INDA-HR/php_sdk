...
/**
 * SlimJobAdSkillDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SlimJobAdSkillDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SlimJobAdSkillDetails';
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight > 1.0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling SlimJobAdSkillDetails., must be smaller than or equal to 1.0.');
        }
        if (($weight < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling SlimJobAdSkillDetails., must be bigger than or equal to 0.0.');
        }
