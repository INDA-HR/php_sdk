...
/**
 * OptionalResumeLanguageDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OptionalResumeLanguageDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OptionalResumeLanguageDetails';
    ...
    protected static $openAPITypes = [
        ...
        'proficiency_level_code' => '\OpenAPI\Client\Model\ProficiencyLevelCode',
        'is_primary' => 'bool'
    ];
    ...
    protected static $setters = [
        ...
        'proficiency_level_code' => 'setProficiencyLevelCode',
    ...
    protected static $getters = [
        ...
        'proficiency_level_code' => 'getProficiencyLevelCode',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('proficiency_level_code', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $proficiency_level A descriptive language proficiency level. E.g.: 'Good', 'Excellent'.
     *
     * @return self
     */
     ...
     * Sets language_code
     *
     * @param string|null $language_code ISO 639 language code.
     *
     * @return self
     */
    ...
    /**
     * Gets proficiency_level_code
     *
     * @return \OpenAPI\Client\Model\ProficiencyLevelCode|null
     */
    public function getProficiencyLevelCode()
    {
        return $this->container['proficiency_level_code'];
    }

    /**
     * Sets proficiency_level_code
     *
     * @param \OpenAPI\Client\Model\ProficiencyLevelCode|null $proficiency_level_code proficiency_level_code
     *
     * @return self
     */
    public function setProficiencyLevelCode($proficiency_level_code)
    {
        if (is_null($proficiency_level_code)) {
            throw new \InvalidArgumentException('non-nullable proficiency_level_code cannot be null');
        }
        $this->container['proficiency_level_code'] = $proficiency_level_code;
     ...
     * Sets is_primary
     *
     * @param bool|null $is_primary Whether the language is primary or not.
     *
     * @return self
     */
