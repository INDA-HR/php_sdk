...
class Award implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('awarder', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['awarder'];
    }

    /**
     * Sets awarder
     *
     * @param \OpenAPI\Client\Model\Organization|null $awarder awarder
     *
     * @return self
     */
    ...
    {
        if (is_null($awarder)) {
            throw new \InvalidArgumentException('non-nullable awarder cannot be null');
        }
        $this->container['awarder'] = $awarder;
