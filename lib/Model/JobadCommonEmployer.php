 ...
 *
 * The version of the OpenAPI document: 2.45140
...
/**
 * JobadCommonEmployer Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class JobadCommonEmployer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JobadCommonEmployer';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => '\OpenAPI\Client\Model\BaseBenefitsValueModelStrictStr'
    ];
     ...
     * Sets id
     *
     * @param string|null $id CompanyID of the employer company.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param \OpenAPI\Client\Model\BaseBenefitsValueModelStrictStr $name name
     *
     * @return self
     */
