...
/**
 * OptionalJobAdJobTitleDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OptionalJobAdJobTitleDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OptionalJobAdJobTitleDetails';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('weight', $data ?? [], 0.75);
    }
    ...
    */
     ...
     * Sets weight
     *
     * @param float|null $weight Weight of the job title. Used for mathing purposes.
     *
     * @return self
     */
    public function setWeight($weight)
    {
        ...
        if (($weight > 1.0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling OptionalJobAdJobTitleDetails., must be smaller than or equal to 1.0.');
        }
        if (($weight < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling OptionalJobAdJobTitleDetails., must be bigger than or equal to 0.0.');
        }
