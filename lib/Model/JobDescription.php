...
/**
 * JobDescription Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class JobDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'position_description' => '\OpenAPI\Client\Model\Section',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('position_requirements', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\Section $position_description position_description
     *
     * @return self
     */
    ...
    {
        if (is_null($position_requirements)) {
            throw new \InvalidArgumentException('non-nullable position_requirements cannot be null');
        }
