...
class History implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'detail' => '\OpenAPI\Client\Model\HistoryDetail[]',
        'advanced' => 'array<string,\OpenAPI\Client\Model\SlimBaseResponse>',
        'not_advanced' => 'array<string,\OpenAPI\Client\Model\SlimBaseResponse>'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('not_advanced', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets prices
     *
     * @param array<string,float>|null $prices prices
     *
     * @return self
     */
     ...
     * Gets detail
     *
     * @return \OpenAPI\Client\Model\HistoryDetail[]|null
     */
     ...
     * Sets detail
     *
     * @param \OpenAPI\Client\Model\HistoryDetail[]|null $detail detail
     *
     * @return self
     */
     ...
     * Gets advanced
     *
     * @return array<string,\OpenAPI\Client\Model\SlimBaseResponse>|null
     */
     ...
     * Sets advanced
     *
     * @param array<string,\OpenAPI\Client\Model\SlimBaseResponse>|null $advanced advanced
     *
     * @return self
     */
     ...
     * @return array<string,\OpenAPI\Client\Model\SlimBaseResponse>|null
     */
    public function getNotAdvanced()
    {
        return $this->container['not_advanced'];
    }

    /**
     * Sets not_advanced
     *
     * @param array<string,\OpenAPI\Client\Model\SlimBaseResponse>|null $not_advanced not_advanced
     *
     * @return self
     */
    public function setNotAdvanced($not_advanced)
    {
        if (is_null($not_advanced)) {
            throw new \InvalidArgumentException('non-nullable not_advanced cannot be null');
        }
        $this->container['not_advanced'] = $not_advanced;
