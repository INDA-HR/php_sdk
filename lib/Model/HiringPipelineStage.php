...
/**
 * HiringPipelineStage Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HiringPipelineStage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HiringPipelineStage';
    ...
    const STATUS_SOURCED = 'SOURCED';
    const STATUS_SCREEN = 'SCREEN';
     ...
     * Sets date
     *
     * @param \DateTime $date The date in which the status changed. Format: 'YYYY-MM-DD' or 'YYYY-MM-DD[T]HH:MM[:SS[.ffffff]][Z or [±]HH[:]MM]]]'.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A brief description indicating the reason why the state has changed. E.g.: the status 'DISQUALIFIED' could be used both to exclude candidates which are unsuitable or those who refused the job offer.
     *
     * @return self
     */
