...
class Certification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'certification_name' => 'setCertificationName',
    ...
    {
        $this->setIfExists('certification_name', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets certification_name
     *
     * @return \OpenAPI\Client\Model\BaseModelsName|null
     */
    public function getCertificationName()
    {
        return $this->container['certification_name'];
    }

    /**
     * Sets certification_name
     *
     * @param \OpenAPI\Client\Model\BaseModelsName|null $certification_name certification_name
     *
     * @return self
     */
    public function setCertificationName($certification_name)
    {
        if (is_null($certification_name)) {
            throw new \InvalidArgumentException('non-nullable certification_name cannot be null');
        }
        $this->container['certification_name'] = $certification_name;
     ...
     * Gets url
     *
     * @return \OpenAPI\Client\Model\ResumeLinkURL|null
     */
     ...
     * Sets url
     *
     * @param \OpenAPI\Client\Model\ResumeLinkURL|null $url url
     *
     * @return self
     */
