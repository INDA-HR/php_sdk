...
class SemanticFeedbackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['terms']) > 100)) {
            $invalidProperties[] = "invalid value for 'terms', number of items must be less than or equal to 100.";
        }
    ...
    public function setTerms($terms)
    {
        ...
        if ((count($terms) > 100)) {
            throw new \InvalidArgumentException('invalid value for $terms when calling SemanticFeedbackRequest., number of items must be less than or equal to 100.');
        }
        if ((count($terms) < 1)) {
