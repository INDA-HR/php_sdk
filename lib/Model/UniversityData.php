...
class UniversityData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'admissions' => false,
		'carnegie_classification' => false,
		'facilities_and_services' => false,
		'faculties' => false,
		'memberships_and_affiliations' => false,
		'yearly_tuition_range' => false,
		'size_and_profile' => false,
		'study_areas' => false,
		'logo' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('other_locations', $data ?? [], null);
        $this->setIfExists('contact_info', $data ?? [], null);
        $this->setIfExists('accreditations', $data ?? [], null);
        $this->setIfExists('admissions', $data ?? [], null);
        $this->setIfExists('carnegie_classification', $data ?? [], null);
        $this->setIfExists('facilities_and_services', $data ?? [], null);
        $this->setIfExists('faculties', $data ?? [], null);
        $this->setIfExists('memberships_and_affiliations', $data ?? [], null);
        $this->setIfExists('yearly_tuition_range', $data ?? [], null);
        $this->setIfExists('size_and_profile', $data ?? [], null);
        $this->setIfExists('study_areas', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($other_locations)) {
            throw new \InvalidArgumentException('non-nullable other_locations cannot be null');
        }
    ...
    {
        if (is_null($accreditations)) {
            throw new \InvalidArgumentException('non-nullable accreditations cannot be null');
        }
    ...
    public function setAdmissions($admissions)
    {
        if (is_null($admissions)) {
            throw new \InvalidArgumentException('non-nullable admissions cannot be null');
        }
    ...
    {
        if (is_null($carnegie_classification)) {
            throw new \InvalidArgumentException('non-nullable carnegie_classification cannot be null');
        }
    ...
    {
        if (is_null($facilities_and_services)) {
            throw new \InvalidArgumentException('non-nullable facilities_and_services cannot be null');
        }
    ...
    public function setFaculties($faculties)
    {
        if (is_null($faculties)) {
            throw new \InvalidArgumentException('non-nullable faculties cannot be null');
        }
    ...
    {
        if (is_null($memberships_and_affiliations)) {
            throw new \InvalidArgumentException('non-nullable memberships_and_affiliations cannot be null');
        }
    ...
    {
        if (is_null($yearly_tuition_range)) {
            throw new \InvalidArgumentException('non-nullable yearly_tuition_range cannot be null');
        }
    ...
    {
        if (is_null($size_and_profile)) {
            throw new \InvalidArgumentException('non-nullable size_and_profile cannot be null');
        }
    ...
    {
        if (is_null($study_areas)) {
            throw new \InvalidArgumentException('non-nullable study_areas cannot be null');
        }
