...
class JobadCommonData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets employer_id
     *
     * @param string $employer_id CompanyID of the employer company.
     *
     * @return self
     */
    ...
    public function setRelatedJobTitles($related_job_titles)
    {
        ...
        if (!is_null($related_job_titles) && (count($related_job_titles) > 6)) {
            throw new \InvalidArgumentException('invalid value for $related_job_titles when calling JobadCommonData., number of items must be less than or equal to 6.');
        }
