...
class OptionalCarnegieClassification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'_2000_classification' => false,
		'size_setting' => false,
		'enrollment_profile' => false,
		'undergraduate_profile' => false,
		'undergraduate_instructional_program' => false,
		'graduate_instructional_program' => false
    ];
    ...
    {
        $this->setIfExists('basic_classification', $data ?? [], null);
        $this->setIfExists('_2000_classification', $data ?? [], null);
        $this->setIfExists('size_setting', $data ?? [], null);
        $this->setIfExists('enrollment_profile', $data ?? [], null);
        $this->setIfExists('undergraduate_profile', $data ?? [], null);
        $this->setIfExists('undergraduate_instructional_program', $data ?? [], null);
        $this->setIfExists('graduate_instructional_program', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($basic_classification)) {
            throw new \InvalidArgumentException('non-nullable basic_classification cannot be null');
        }
    ...
    {
        if (is_null($_2000_classification)) {
            throw new \InvalidArgumentException('non-nullable _2000_classification cannot be null');
        }
    ...
    {
        if (is_null($size_setting)) {
            throw new \InvalidArgumentException('non-nullable size_setting cannot be null');
        }
    ...
    {
        if (is_null($enrollment_profile)) {
            throw new \InvalidArgumentException('non-nullable enrollment_profile cannot be null');
        }
    ...
    {
        if (is_null($undergraduate_profile)) {
            throw new \InvalidArgumentException('non-nullable undergraduate_profile cannot be null');
        }
    ...
    {
        if (is_null($undergraduate_instructional_program)) {
            throw new \InvalidArgumentException('non-nullable undergraduate_instructional_program cannot be null');
        }
    ...
    {
        if (is_null($graduate_instructional_program)) {
            throw new \InvalidArgumentException('non-nullable graduate_instructional_program cannot be null');
        }
