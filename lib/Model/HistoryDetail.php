...
/**
 * HistoryDetail Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HistoryDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoryDetail';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('api_call', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['api_call'] === null) {
            $invalidProperties[] = "'api_call' can't be null";
        }
    ...
    {
        return $this->container['api_call'];
    }

    /**
     * Sets api_call
     *
     * @param string $api_call api_call
     *
     * @return self
     */
    ...
    {
        if (is_null($api_call)) {
            throw new \InvalidArgumentException('non-nullable api_call cannot be null');
        }
        $this->container['api_call'] = $api_call;
