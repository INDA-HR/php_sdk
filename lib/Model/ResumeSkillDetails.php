...
/**
 * ResumeSkillDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResumeSkillDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResumeSkillDetails';
    ...
    public function setScore($score)
    {
        ...
        if (!is_null($score) && ($score > 1.0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling ResumeSkillDetails., must be smaller than or equal to 1.0.');
        }
        if (!is_null($score) && ($score < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling ResumeSkillDetails., must be bigger than or equal to 0.0.');
        }
