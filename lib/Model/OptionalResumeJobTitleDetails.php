...
/**
 * OptionalResumeJobTitleDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OptionalResumeJobTitleDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OptionalResumeJobTitleDetails';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['score'] = $data['score'] ?? 0.75;
    ...
    public function setScore($score)
    {
        ...
        if (!is_null($score) && ($score > 1.0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling OptionalResumeJobTitleDetails., must be smaller than or equal to 1.0.');
        }
        if (!is_null($score) && ($score < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling OptionalResumeJobTitleDetails., must be bigger than or equal to 0.0.');
        }
