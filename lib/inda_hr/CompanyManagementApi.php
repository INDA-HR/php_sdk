...
class CompanyManagementApi
{
     ...
     */
    public function companyAutocompleteGET($term, $size = 10, $token_order = 'any', $fuzzy = false)
    {
        list($response) = $this->companyAutocompleteGETWithHttpInfo($term, $size, $token_order, $fuzzy);
        return $response;
    }
     ...
     */
    public function companyAutocompleteGETWithHttpInfo($term, $size = 10, $token_order = 'any', $fuzzy = false)
    {
        $request = $this->companyAutocompleteGETRequest($term, $size, $token_order, $fuzzy);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyAutocompleteGETAsync($term, $size = 10, $token_order = 'any', $fuzzy = false)
    {
        return $this->companyAutocompleteGETAsyncWithHttpInfo($term, $size, $token_order, $fuzzy)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyAutocompleteGETAsyncWithHttpInfo($term, $size = 10, $token_order = 'any', $fuzzy = false)
    {
        $returnType = '\OpenAPI\Client\Model\CompanyAutocompleteResponse';
        $request = $this->companyAutocompleteGETRequest($term, $size, $token_order, $fuzzy);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function companyAutocompleteGETRequest($term, $size = 10, $token_order = 'any', $fuzzy = false)
    {
