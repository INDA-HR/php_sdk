...
class ApplicationManagementApi
{
     ...
     */
    public function applyPOST($indexname, $jobad_id, $apply_item_request, $resume_id = null)
    {
        list($response) = $this->applyPOSTWithHttpInfo($indexname, $jobad_id, $apply_item_request, $resume_id);
        return $response;
    }
     ...
     */
    public function applyPOSTWithHttpInfo($indexname, $jobad_id, $apply_item_request, $resume_id = null)
    {
        $request = $this->applyPOSTRequest($indexname, $jobad_id, $apply_item_request, $resume_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function applyPOSTAsync($indexname, $jobad_id, $apply_item_request, $resume_id = null)
    {
        return $this->applyPOSTAsyncWithHttpInfo($indexname, $jobad_id, $apply_item_request, $resume_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function applyPOSTAsyncWithHttpInfo($indexname, $jobad_id, $apply_item_request, $resume_id = null)
    {
        $returnType = '\OpenAPI\Client\Model\ApplicationIDResponse';
        $request = $this->applyPOSTRequest($indexname, $jobad_id, $apply_item_request, $resume_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function applyPOSTRequest($indexname, $jobad_id, $apply_item_request, $resume_id = null)
    {
        // verify the required parameter 'indexname' is set
        if ($indexname === null || (is_array($indexname) && count($indexname) === 0)) {
            throw new \InvalidArgumentException(
