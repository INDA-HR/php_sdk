...
class ResumeManagementApi
{
     ...
     */
    public function addResumePOST($indexname, $file_item_request, $sync = false, $resume_id = null)
    {
        list($response) = $this->addResumePOSTWithHttpInfo($indexname, $file_item_request, $sync, $resume_id);
        return $response;
    }
     ...
     */
    public function addResumePOSTWithHttpInfo($indexname, $file_item_request, $sync = false, $resume_id = null)
    {
        $request = $this->addResumePOSTRequest($indexname, $file_item_request, $sync, $resume_id);
     ...
     */
    public function addResumePOSTAsync($indexname, $file_item_request, $sync = false, $resume_id = null)
    {
        return $this->addResumePOSTAsyncWithHttpInfo($indexname, $file_item_request, $sync, $resume_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addResumePOSTAsyncWithHttpInfo($indexname, $file_item_request, $sync = false, $resume_id = null)
    {
        $returnType = '\OpenAPI\Client\Model\ItemIdResponse';
        $request = $this->addResumePOSTRequest($indexname, $file_item_request, $sync, $resume_id);
     ...
     */
    public function addResumePOSTRequest($indexname, $file_item_request, $sync = false, $resume_id = null)
    {
     ...
     */
    public function patchResumePATCH($indexname, $resume_id, $patch_item_request)
    {
        list($response) = $this->patchResumePATCHWithHttpInfo($indexname, $resume_id, $patch_item_request);
        return $response;
    }
     ...
     */
    public function patchResumePATCHWithHttpInfo($indexname, $resume_id, $patch_item_request)
    {
        $request = $this->patchResumePATCHRequest($indexname, $resume_id, $patch_item_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchResumePATCHAsync($indexname, $resume_id, $patch_item_request)
    {
        return $this->patchResumePATCHAsyncWithHttpInfo($indexname, $resume_id, $patch_item_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchResumePATCHAsyncWithHttpInfo($indexname, $resume_id, $patch_item_request)
    {
        $returnType = '\OpenAPI\Client\Model\PatchItemResponse';
        $request = $this->patchResumePATCHRequest($indexname, $resume_id, $patch_item_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchResumePATCHRequest($indexname, $resume_id, $patch_item_request)
    {
        // verify the required parameter 'indexname' is set
        if ($indexname === null || (is_array($indexname) && count($indexname) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function updateResumePUT($indexname, $resume_id, $update_item_request)
    {
        list($response) = $this->updateResumePUTWithHttpInfo($indexname, $resume_id, $update_item_request);
        return $response;
    }
     ...
     */
    public function updateResumePUTWithHttpInfo($indexname, $resume_id, $update_item_request)
    {
        $request = $this->updateResumePUTRequest($indexname, $resume_id, $update_item_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateResumePUTAsync($indexname, $resume_id, $update_item_request)
    {
        return $this->updateResumePUTAsyncWithHttpInfo($indexname, $resume_id, $update_item_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateResumePUTAsyncWithHttpInfo($indexname, $resume_id, $update_item_request)
    {
        $returnType = '\OpenAPI\Client\Model\BaseItemIdResponse';
        $request = $this->updateResumePUTRequest($indexname, $resume_id, $update_item_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateResumePUTRequest($indexname, $resume_id, $update_item_request)
    {
        // verify the required parameter 'indexname' is set
        if ($indexname === null || (is_array($indexname) && count($indexname) === 0)) {
            throw new \InvalidArgumentException(
