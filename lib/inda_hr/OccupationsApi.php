...
class OccupationsApi
{
     ...
     * @param  string $lang Language of the jobtitle. (optional, default to 'it')
     *
     ...
     */
    public function similarJobtitlesGET($query, $size = 10, $min_score = 0.5, $lang = 'it')
    {
        list($response) = $this->similarJobtitlesGETWithHttpInfo($query, $size, $min_score, $lang);
        return $response;
    }
     ...
     */
    public function similarJobtitlesGETWithHttpInfo($query, $size = 10, $min_score = 0.5, $lang = 'it')
    {
        $request = $this->similarJobtitlesGETRequest($query, $size, $min_score, $lang);
     ...
     */
    public function similarJobtitlesGETAsync($query, $size = 10, $min_score = 0.5, $lang = 'it')
    {
        return $this->similarJobtitlesGETAsyncWithHttpInfo($query, $size, $min_score, $lang)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function similarJobtitlesGETAsyncWithHttpInfo($query, $size = 10, $min_score = 0.5, $lang = 'it')
    {
        $returnType = '\OpenAPI\Client\Model\SimilarEntitiesResponse';
        $request = $this->similarJobtitlesGETRequest($query, $size, $min_score, $lang);
     ...
     */
    public function similarJobtitlesGETRequest($query, $size = 10, $min_score = 0.5, $lang = 'it')
    {
        ...
        if ($size !== null && $size > 40) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling OccupationsApi.similarJobtitlesGET, must be smaller than or equal to 40.');
        }
