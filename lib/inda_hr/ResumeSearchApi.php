...
class ResumeSearchApi
{
     ...
     *
     * @param  string $indexname indexname (required)
     * @param  AnyOfStringString $jobad_id jobad_id (required)
     ...
     *
     * @param  string $indexname (required)
     * @param  AnyOfStringString $jobad_id (required)
     * @param  int $cache_time Optional. Seconds. (optional, default to 300)
     * @param  int $size Optional. Number of documents to return. (optional, default to 50)
     * @param  string $search_id Both the initial search request and each subsequent scroll request returns a *SearchID*. The *SearchID* may or may not  change between requests; however, only the most recently received *SearchID* should be used. (optional)
     ...
     */
    public function searchResumesEvidencePOST($indexname, $evidence_request, $size = 3)
    {
        list($response) = $this->searchResumesEvidencePOSTWithHttpInfo($indexname, $evidence_request, $size);
        return $response;
    }
     ...
     */
    public function searchResumesEvidencePOSTWithHttpInfo($indexname, $evidence_request, $size = 3)
    {
        $request = $this->searchResumesEvidencePOSTRequest($indexname, $evidence_request, $size);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchResumesEvidencePOSTAsync($indexname, $evidence_request, $size = 3)
    {
        return $this->searchResumesEvidencePOSTAsyncWithHttpInfo($indexname, $evidence_request, $size)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchResumesEvidencePOSTAsyncWithHttpInfo($indexname, $evidence_request, $size = 3)
    {
        $returnType = '\OpenAPI\Client\Model\SearchEvidence[]';
        $request = $this->searchResumesEvidencePOSTRequest($indexname, $evidence_request, $size);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchResumesEvidencePOSTRequest($indexname, $evidence_request, $size = 3)
    {
        // verify the required parameter 'indexname' is set
        if ($indexname === null || (is_array($indexname) && count($indexname) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function searchResumesPOST($indexname, $cache = true, $cache_time = 300, $size = 50, $offset = 0, $min_score = 0, $search_id = null, $docs_search_query = null)
    {
        list($response) = $this->searchResumesPOSTWithHttpInfo($indexname, $cache, $cache_time, $size, $offset, $min_score, $search_id, $docs_search_query);
        return $response;
    }
     ...
     */
    public function searchResumesPOSTWithHttpInfo($indexname, $cache = true, $cache_time = 300, $size = 50, $offset = 0, $min_score = 0, $search_id = null, $docs_search_query = null)
    {
        $request = $this->searchResumesPOSTRequest($indexname, $cache, $cache_time, $size, $offset, $min_score, $search_id, $docs_search_query);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchResumesPOSTAsync($indexname, $cache = true, $cache_time = 300, $size = 50, $offset = 0, $min_score = 0, $search_id = null, $docs_search_query = null)
    {
        return $this->searchResumesPOSTAsyncWithHttpInfo($indexname, $cache, $cache_time, $size, $offset, $min_score, $search_id, $docs_search_query)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchResumesPOSTAsyncWithHttpInfo($indexname, $cache = true, $cache_time = 300, $size = 50, $offset = 0, $min_score = 0, $search_id = null, $docs_search_query = null)
    {
        $returnType = '\OpenAPI\Client\Model\FoundDocsResponse';
        $request = $this->searchResumesPOSTRequest($indexname, $cache, $cache_time, $size, $offset, $min_score, $search_id, $docs_search_query);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchResumesPOSTRequest($indexname, $cache = true, $cache_time = 300, $size = 50, $offset = 0, $min_score = 0, $search_id = null, $docs_search_query = null)
    {
        // verify the required parameter 'indexname' is set
        if ($indexname === null || (is_array($indexname) && count($indexname) === 0)) {
            throw new \InvalidArgumentException(
