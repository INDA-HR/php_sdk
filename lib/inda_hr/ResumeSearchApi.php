...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['fullTextSearchOnResumesPOST'] to see the possible values for this operation
     *
     ...
     */
    public function fullTextSearchOnResumesPOST($indexname, $default_operator = 'OR', $cache = true, $cache_time = 300, $size = 50, $offset = 0, $min_score = 0, $search_id = null, $traditional_docs_search_query = null, string $contentType = self::contentTypes['fullTextSearchOnResumesPOST'][0])
    {
        list($response) = $this->fullTextSearchOnResumesPOSTWithHttpInfo($indexname, $default_operator, $cache, $cache_time, $size, $offset, $min_score, $search_id, $traditional_docs_search_query, $contentType);
        return $response;
    }
     ...
     */
    public function fullTextSearchOnResumesPOSTWithHttpInfo($indexname, $default_operator = 'OR', $cache = true, $cache_time = 300, $size = 50, $offset = 0, $min_score = 0, $search_id = null, $traditional_docs_search_query = null, string $contentType = self::contentTypes['fullTextSearchOnResumesPOST'][0])
    {
        $request = $this->fullTextSearchOnResumesPOSTRequest($indexname, $default_operator, $cache, $cache_time, $size, $offset, $min_score, $search_id, $traditional_docs_search_query, $contentType);
     ...
     */
    public function fullTextSearchOnResumesPOSTAsync($indexname, $default_operator = 'OR', $cache = true, $cache_time = 300, $size = 50, $offset = 0, $min_score = 0, $search_id = null, $traditional_docs_search_query = null, string $contentType = self::contentTypes['fullTextSearchOnResumesPOST'][0])
    {
        return $this->fullTextSearchOnResumesPOSTAsyncWithHttpInfo($indexname, $default_operator, $cache, $cache_time, $size, $offset, $min_score, $search_id, $traditional_docs_search_query, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fullTextSearchOnResumesPOSTAsyncWithHttpInfo($indexname, $default_operator = 'OR', $cache = true, $cache_time = 300, $size = 50, $offset = 0, $min_score = 0, $search_id = null, $traditional_docs_search_query = null, string $contentType = self::contentTypes['fullTextSearchOnResumesPOST'][0])
    {
        $returnType = '\OpenAPI\Client\Model\FoundDocsResponse';
        $request = $this->fullTextSearchOnResumesPOSTRequest($indexname, $default_operator, $cache, $cache_time, $size, $offset, $min_score, $search_id, $traditional_docs_search_query, $contentType);
     ...
     */
    public function fullTextSearchOnResumesPOSTRequest($indexname, $default_operator = 'OR', $cache = true, $cache_time = 300, $size = 50, $offset = 0, $min_score = 0, $search_id = null, $traditional_docs_search_query = null, string $contentType = self::contentTypes['fullTextSearchOnResumesPOST'][0])
    {
        ...
        if (isset($traditional_docs_search_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($traditional_docs_search_query));
            } else {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchApplicantsPOST'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function searchApplicantsPOST($indexname, $jobad_id, $cache_time = 300, $size = 50, $search_id = null, $candidate_search_query = null, string $contentType = self::contentTypes['searchApplicantsPOST'][0])
    {
        list($response) = $this->searchApplicantsPOSTWithHttpInfo($indexname, $jobad_id, $cache_time, $size, $search_id, $candidate_search_query, $contentType);
        return $response;
    }
     ...
     */
    public function searchApplicantsPOSTWithHttpInfo($indexname, $jobad_id, $cache_time = 300, $size = 50, $search_id = null, $candidate_search_query = null, string $contentType = self::contentTypes['searchApplicantsPOST'][0])
    {
        $request = $this->searchApplicantsPOSTRequest($indexname, $jobad_id, $cache_time, $size, $search_id, $candidate_search_query, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchApplicantsPOSTAsync($indexname, $jobad_id, $cache_time = 300, $size = 50, $search_id = null, $candidate_search_query = null, string $contentType = self::contentTypes['searchApplicantsPOST'][0])
    {
        return $this->searchApplicantsPOSTAsyncWithHttpInfo($indexname, $jobad_id, $cache_time, $size, $search_id, $candidate_search_query, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchApplicantsPOSTAsyncWithHttpInfo($indexname, $jobad_id, $cache_time = 300, $size = 50, $search_id = null, $candidate_search_query = null, string $contentType = self::contentTypes['searchApplicantsPOST'][0])
    {
        $returnType = '\OpenAPI\Client\Model\FoundCandidatesResponse';
        $request = $this->searchApplicantsPOSTRequest($indexname, $jobad_id, $cache_time, $size, $search_id, $candidate_search_query, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchApplicantsPOSTRequest($indexname, $jobad_id, $cache_time = 300, $size = 50, $search_id = null, $candidate_search_query = null, string $contentType = self::contentTypes['searchApplicantsPOST'][0])
    {
        ...
        if (isset($candidate_search_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($candidate_search_query));
            } else {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchResumesEvidencePOST'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function searchResumesEvidencePOST($indexname, $evidence_request, $size = 3, $src_lang = null, string $contentType = self::contentTypes['searchResumesEvidencePOST'][0])
    {
        list($response) = $this->searchResumesEvidencePOSTWithHttpInfo($indexname, $evidence_request, $size, $src_lang, $contentType);
        return $response;
    }
     ...
     */
    public function searchResumesEvidencePOSTWithHttpInfo($indexname, $evidence_request, $size = 3, $src_lang = null, string $contentType = self::contentTypes['searchResumesEvidencePOST'][0])
    {
        $request = $this->searchResumesEvidencePOSTRequest($indexname, $evidence_request, $size, $src_lang, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchResumesEvidencePOSTAsync($indexname, $evidence_request, $size = 3, $src_lang = null, string $contentType = self::contentTypes['searchResumesEvidencePOST'][0])
    {
        return $this->searchResumesEvidencePOSTAsyncWithHttpInfo($indexname, $evidence_request, $size, $src_lang, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchResumesEvidencePOSTAsyncWithHttpInfo($indexname, $evidence_request, $size = 3, $src_lang = null, string $contentType = self::contentTypes['searchResumesEvidencePOST'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SearchEvidence[]';
        $request = $this->searchResumesEvidencePOSTRequest($indexname, $evidence_request, $size, $src_lang, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchResumesEvidencePOSTRequest($indexname, $evidence_request, $size = 3, $src_lang = null, string $contentType = self::contentTypes['searchResumesEvidencePOST'][0])
    {
        ...
        if (isset($evidence_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($evidence_request));
            } else {
    ...
    public function searchResumesPOSTRequest($indexname, $cache = true, $cache_time = 300, $size = 50, $offset = 0, $min_score = 0, $search_id = null, $src_lang = null, $dst_lang = null, $docs_search_query = null, string $contentType = self::contentTypes['searchResumesPOST'][0])
    {
        ...
        if (isset($docs_search_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($docs_search_query));
            } else {
